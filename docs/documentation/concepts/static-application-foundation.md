...
- The `FoundationLayout.astro` document boundary that renders the [Stage 1 Site Shell](./public-interface/stage-1-site-shell.md) around page content.
- The global stylesheet entry point and locally bundled fonts used by the [Frontier Atlas Design System](./public-interface/frontier-atlas-design-system.md).
...
- [Canonical record contracts or cross-record validation](./evidence-ledger/canonical-records.md).
...
- Cloudflare project settings, production deployment, or rollback behavior. [Cloudflare Pages Deployment](./deployment-and-verification/cloudflare-pages-deployment.md) owns that system.
- Release selection, release verification, internal manifests, or promotion. [Repeatable Release Publication](./release-lifecycle/repeatable-release-publication.md) owns that workflow.
...
The `/` route is the static [Stage 1 Homepage](./public-interface/stage-1-homepage.md), `/about/` is the static [Stage 1 About Page](./public-interface/stage-1-about-page.md), `/changelog/` is the static [Stage 1 Changelog Page](./public-interface/stage-1-changelog-page.md), and `/export/` is the static [Stage 1 Export JSON Page](./public-interface/stage-1-export-json-page.md). Current public Entry routes are generated by the [Stage 1 Entry Page](./public-interface/stage-1-entry-page.md), and current Topic Trail routes are generated by the [Stage 1 Topic Trail Page](./public-interface/stage-1-topic-trail-page.md). The [Stage 1 Methodology Page](./public-interface/stage-1-methodology-page.md) generates `/methodology/` and the single immutable `/methodology/1.0.0/` route. The project-level `404.astro` produces the generic static `404.html`. Their complete release-selected content is generated into HTML.
...
The canonical-record domain module defines the data contracts consumed by loaders, [publication revisions](./evidence-ledger/publication-revisions.md), [release construction](./release-lifecycle/release-construction.md), pages, and exports. Publication revisions, material activity, routing, [dataset generation](./release-lifecycle/dataset-generation.md), and release construction remain framework-independent; the foundation provides their dependency boundary and test environment but does not own their behavior.
...
The [Stage 1 Homepage](./public-interface/stage-1-homepage.md), [Stage 1 About Page](./public-interface/stage-1-about-page.md), [Stage 1 Changelog Page](./public-interface/stage-1-changelog-page.md), [Stage 1 Entry Page](./public-interface/stage-1-entry-page.md), [Stage 1 Export JSON Page](./public-interface/stage-1-export-json-page.md), [Stage 1 Methodology Page](./public-interface/stage-1-methodology-page.md), and [Stage 1 Topic Trail Page](./public-interface/stage-1-topic-trail-page.md) receive resolved release data through the Astro boundary. Their feature modules do not load files, access the environment, generate release metadata, or fetch canonical content in the browser.
...
[Cloudflare Pages Deployment](./deployment-and-verification/cloudflare-pages-deployment.md) consumes the foundation's static output after strict release validation. The downloaded deployment artifact runs the same production sitemap verification before upload. The deployment workflow does not move Cloudflare concerns into Astro pages or domain modules.

[Hosted Release Verification](./deployment-and-verification/hosted-release-verification.md) reuses the same desktop and mobile projects, keyboard and focus checks, supported-width overflow assertions, downloads, no-JavaScript journeys, and Axe scans against the live origin. Hosting API access remains outside the browser harness.
...
Frontier Atlas owns presentation tokens, typography roles, shared components, and responsive behavior. The foundation owns the Astro document boundary that loads those styles, the build process, and the test harness. The [Stage 1 Site Shell](./public-interface/stage-1-site-shell.md) owns the Header, Footer, navigation, skip-link behavior, and required page order rendered through that boundary. Page modules provide main content and must not move presentation rules into the framework-independent domain layer.
...
- Whether a presentation change preserves the [Frontier Atlas](./public-interface/frontier-atlas-design-system.md) ownership boundary and accessibility invariants.
- Whether a page or layout change preserves the [Stage 1 Site Shell](./public-interface/stage-1-site-shell.md) order, navigation, and no-JavaScript behavior.
- Whether an Entry list integration preserves the [Entry Preview](./public-interface/entry-preview.md) projection and sequence while using only its approved host options.
- Whether Entry route changes preserve the [Stage 1 Entry Page](./public-interface/stage-1-entry-page.md) release boundary, static generation, and genuine not-found response.
...
- Whether a production-release change belongs to [Repeatable Release Publication](./release-lifecycle/repeatable-release-publication.md) rather than the ordinary Astro foundation.
- Whether a hosting or artifact-transfer change belongs to [Cloudflare Pages Deployment](./deployment-and-verification/cloudflare-pages-deployment.md).
- Whether hosted browser behavior belongs to [Hosted Release Verification](./deployment-and-verification/hosted-release-verification.md) rather than the ordinary local test command.
