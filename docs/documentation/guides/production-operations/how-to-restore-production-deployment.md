---
label: How To Restore A Production Deployment
order: 200
---
...
If Cloudflare cannot make the intended ID canonical, keep the production incident open and do not start the rollback rehearsal. The [Hosted Release Verification](../../concepts/deployment-and-verification/hosted-release-verification.md) concept explains the evidence and restoration contract; the [Cloudflare Pages Deployment](../../concepts/deployment-and-verification/cloudflare-pages-deployment.md) concept explains deployment selection and identity boundaries.
